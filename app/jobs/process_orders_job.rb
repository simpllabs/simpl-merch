class ProcessOrdersJob < ProgressJob::Base
  ...
  def perform
    ...
    csv_string = CSV.generate do |csv|
      ...
      header = ["TRACKING NUMBER", "Shipping Method", "Order ID", "Shop Domain", "Gender", "Front Design URL", "Back Design URL", "Front Reference URL", "Back Reference URL","Status", "SKU", "Quantity", "Shipping Name", "Shipping Address1", "Shipping Address2", "Shipping Company", "Shipping City", "Shipping ZIP", "Shipping Province/State", "Shipping Country"]
